---
name: codeb-rollback
description: "롤백", "rollback", "되돌리기", "이전 버전", "복원" 등의 요청 시 자동 활성화. 이전 버전으로 즉시 롤백합니다.
---

# CodeB Rollback Skill

Blue-Green 슬롯을 사용하여 이전 버전으로 즉시 롤백하는 스킬입니다.
